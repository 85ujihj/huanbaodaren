...
//    int getSelectedCount() const;
    ...
    cocos2d::Vec2 getHomeFromCellPos();
    
    cocos2d::Vec2 getFirmFromCellPos();
    ...
    ActionInterval* cellAction(cocos2d::Vec2 point, float time=0.25f);
...
private:
    ...
    std::deque<cocos2d::Vec2> m_nPointOffset;
